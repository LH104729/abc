...
static int DddmpCuddDdArrayStorePrefixStep(DdManager * ddMgr, DdNode * f, FILE * fp, st__table * visited, char ** names);
...
static int DddmpCuddDdArrayStoreBlifStep(DdManager *ddMgr, DdNode *f, FILE *fp, st__table *visited, char **names);
...
static int DddmpCuddDdArrayStoreSmvStep(DdManager * ddMgr, DdNode * f, FILE * fp, st__table * visited, char ** names);
  ...
  )
{
  ...
  Dddmp_CheckAndGotoLabel (visited==NULL,
    "Error if function st__init_table.", failure);
